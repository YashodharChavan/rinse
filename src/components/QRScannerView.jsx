...
export function QRScannerView({ onScan, onClose, onManualEntry }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex flex-col font-sans overflow-hidden bg-cyan-200">
      ...
      <div className="flex-1 flex flex-col items-center justify-start pt-8 sm:pt-12 px-6 z-10">
        ...
        <div className="border-4 border-black px-4 py-2 mb-6 bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] -rotate-2">
          <p className="font-black text-sm uppercase">Find the poster in the lobby 👇</p>
        </div>

        {/* The Scanner Window */}
        <div className="w-full max-w-[320px] aspect-square border-8 border-black bg-gray-900 relative shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none flex flex-col items-center justify-center">
             <div className="w-3/4 h-3/4 border-4 border-dashed border-yellow-300 opacity-80"></div>
        ...
        <div className="mt-auto mb-8 w-full max-w-[320px] flex flex-col gap-4">
          ...
          {/* HELP BUTTON (Now full width) */}
          <button
            onClick={() => setShowHelp(true)}
            className="w-full border-4 border-black bg-green-300 hover:bg-green-400 p-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center gap-3 active:translate-y-1 active:translate-x-1 active:shadow-none transition-all"
          >
            <span className="font-black text-lg uppercase tracking-widest">Help</span>
          </button>
        </div>
      </div>
