  ...
  return (
    <div className="p-4 sm:p-6 pb-32">
      <div className="max-w-lg mx-auto space-y-6">
        ...
        {/* Header Card */}
        <div className="border-4 border-black p-8 bg-cyan-300 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] text-center">
          <div className="text-6xl mb-4">👤</div>
          <h2 className="text-2xl font-black tracking-tight mb-2">{fullName}</h2>
          <p className="font-bold text-sm bg-white inline-block px-3 py-1 border-2 border-black">
            {user?.email}
          </p>
        </div>
        ...
        <form onSubmit={handleSave} className="border-4 border-black p-6 bg-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
          <div className="space-y-4">
            ...
            {/* Status Message */}
            {message && (
              <div className={`p-3 font-black text-center border-4 border-black ${
